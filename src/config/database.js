...
if (useNeonLocal) {
    ...
    console.log(`🔧 Configured for Neon Local at ${neonLocalHost}:${neonLocalPort}`);
}
...
console.log(`📦 Database mode: ${useNeonLocal ? 'Neon Local (Development)' : 'Neon Cloud (Production)'}`);
